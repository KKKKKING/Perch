...
Actions tab with an `X.Y.Z` version. It builds Perch on macOS, creates a
universal Apple Silicon + Intel DMG, uploads it as a workflow artifact, and
publishes it to the matching `vX.Y.Z` GitHub Release.
